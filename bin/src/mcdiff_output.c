...
fprintf(fout, "#    REFLECTION LIST\n");
 ...
 {if(code<2)
   ...
   {if((double)(i-imin)/50==(double)((i-imin)/50))
    {fprintf(fout, "#{h     k      l  %s %s %s Inuc(2t)    Imag(2t)  Itot(2t)[b/Nat^2] %s %s Imag_dip(2t) Iobs\n",
             colheader[colcode[4]],colheader[colcode[5]],colheader[colcode[6]],colheader[colcode[10]],colheader[colcode[11]]);}
   ...
   {if((double)(i-imin)/50==(double)((i-imin)/50))
    {fprintf(fout, "#{h     k      l  %s %s %s Inuc(2t)    Imag(2t)  Itot(2t)[b/Nat^2] %s %s Imag_dip(2t) Iobs        error\n",
          colheader[colcode[4]],colheader[colcode[5]],colheader[colcode[6]],colheader[colcode[10]],colheader[colcode[11]]);}
