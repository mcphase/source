...
{ printf (" program single ion  - calculate single ion expectations values <Ia> <Ib> ... \n" 
          ...
          "options: -nt ......... !ATTENTION! by default only 5 transition energies are considered  \n"
          ...
          "   Susceptibilities (!mind to set number of transitions large enough using option -nt to get correct results!):\n"
