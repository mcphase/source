...
void getU(double & U0,double & Eelastic,int & r, double & spinchange,Vector & Happ,double & T,
           inipar & ini,par & p, spincf & sps, mfcf & mf,const char * info)
{double fe;
...
getU(U0,Eelastic,r,spinchange,Happ,T,ini,phon,spsp,mfp,"test");
