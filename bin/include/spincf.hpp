...
//print list of atoms + positions + moments
    ...
    void jvx_cd(FILE * fout,char * text,cryststruct & cs,
              graphic_parameters & gp, double phase, spincf  savev_real, spincf  savev_imag,
              Vector & hkl, double & T, Vector &  gjmbHxc, Vector & Hext, cryststruct & cs4, spincf  magmom, spincf magmomev_real, spincf  magmomev_imag, spincf  phonon);
    void jvx_cd(FILE * fout,char * text,cryststruct & cs,
              graphic_parameters & gp,double phase,spincf & savev_real,spincf & savev_imag,
              Vector & hkl,double & T, Vector &  gjmbHxc,Vector & Hext,cryststruct & cs4,spincf & magmom,spincf & magmomev_real, spincf & magmomev_imag,spincf & phonon,spincf & pev_real, spincf & pev_imag);
