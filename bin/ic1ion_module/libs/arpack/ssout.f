...
*
*  Usage:      CALL SSOUT (LOUT, N, SX, IDIGIT, IFMT)
*
*  Arguments
...
*-----------------------------------------------------------------------
*
      SUBROUTINE SSOUT( LOUT, N, SX, IDIGIT, IFMT )
*     ...
...
*
      IF( IDIGIT.LT.0 ) THEN
         ...
         IF( NDIGIT.LE.4 ) THEN
            DO 30 K1 = 1, N, 5
               K2 = MIN0( N, K1+4 )
               WRITE( LOUT, 9998 )K1, K2, SX
   30       CONTINUE
         ELSE IF( NDIGIT.LE.6 ) THEN
            DO 40 K1 = 1, N, 4
               K2 = MIN0( N, K1+3 )
               WRITE( LOUT, 9997 )K1, K2, SX
   40       CONTINUE
         ELSE IF( NDIGIT.LE.10 ) THEN
            DO 50 K1 = 1, N, 3
               K2 = MIN0( N, K1+2 )
               WRITE( LOUT, 9996 )K1, K2, SX
   50       CONTINUE
         ELSE
            DO 60 K1 = 1, N, 2
               K2 = MIN0( N, K1+1 )
               WRITE( LOUT, 9995 )K1, K2, SX
   60       CONTINUE
         END IF
*
*=======================================================================
