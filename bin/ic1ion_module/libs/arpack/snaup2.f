...
c     %----------------------%
c
      external   scopy , sgetv0, snaitr, snconv, sneigh, isout,
     &           sngets, snapps, svout , ssout, ivout , arscnd
c
c     %--------------------%
...
c
         if (msglvl .gt. 0) then
            call isout (logfil, 1, iter, ndigit, 
...
c
         if (msglvl .gt. 1) then
            call isout (logfil, 1, nev, ndigit, 
     &     '_naup2: The length of the current Arnoldi factorization')
            call isout (logfil, 1, np, ndigit, 
...
c     
         if (msglvl .gt. 0) then
            call isout (logfil, 1, nconv, ndigit, 
