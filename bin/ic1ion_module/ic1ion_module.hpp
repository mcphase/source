...
{private:
  icpars pars; 
  icmfmat mfmat; // Operators I1 I2 I3 I4 I5 I6 I7 = Sx Sy Sz Lx Ly Lz T2-2 T2-1 T20 ....
  icmfmat Sxmat; // Operators for spin density
  icmfmat Symat; // Operators for spin density
  icmfmat Szmat; // Operators for spin density
  icmfmat Lxmat; // Operators for orbital moment density
  icmfmat Lymat; // Operators for orbital moment density
  icmfmat Lzmat; // Operators for orbital moment density
  
  sMat<double> Hic,iHic;
  // sum exchange field and external field
  Vector sum_Hxc_Hext(Vector & Hxc,Vector & Hext);
                                    //general expectation value calculator
 void expJ(icmfmat & mfmat,     // Operators to be calculated
...
void expJ(icmfmat & mfmat,     // Operators to be calculated
                      ...
                      double&T,           // Input Vector of temperatures
                      Vector &Hxc,        // Input vector of exchange fields (meV) 
                      Vector &Hext,       // Input vector of external field (T) 
...
// --------------------------------------------------------------------------------------------------------------- //
void truncate_hmltn(icpars &pars,  sMat<double> &Hic, sMat<double> &iHic, int JHi, int JLo);
...
ic1ion_module(const ic1ion_module & pp);
