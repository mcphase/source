	    ...
	    for(mj=-j; mj<=j; mj+=2)
            {
               ...
               if(j%2==0) snprintf(Jlabel,12,"%i",j/2); else snprintf(Jlabel,12,"%i/2",j); id.append(Jlabel);
               if(mj%2==0) snprintf(Jlabel,12,",mJ=%i",mj/2); else snprintf(Jlabel,12,",mJ=%i/2",mj); id.append(Jlabel);
