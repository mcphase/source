...
"Ru",	[7.03,	0,	1,	"3,4,5,6,8,2",	1.34,	[207,183,173]],
...
# Radial expectation values are from CFIELD(theta.c) by Peter Fabi [Rare Earths, freeman 1979 JMMM 12,p.11-21] 
# and Maurits Haverkort's thesis.
# Spin orbit zeta and Coulomb Fk parameters (in meV) taken from ic1ion (mostly from Carnall et al. J Chem Phys)
# for O2+ values from COWAN program
$a0=0.5292; $a2=$a0**2; $a4=$a0**4;
%magions = (
"O2+",  ["2p2", 1 ,     "",     "",     2.,     0.9050/$a2,0,       0,  36.7131,        13627,          0,              0],
...
"Co4+",	["3d5",	2.5,	"",	"",	2.,	0.262/$a2,0.141/$a4,0,	82,		13638,		8572,		0],
...
"Ru5+", ["4d3", 1.5,    "",     "",     2.,     1.994    ,6.427    ,0,  176,            9645,           6413,           0],
...
"Pr4+",	["4f1",	"",	"",	"Ce3+",	6./7,	1.015,	2.192,	8.692,	114.44,		0,		0,		0],
...
"Ce3+edvardson",	["4f1",	"",	"",	"Ce3+",	6./7,	 0.71344, 5.3652316, 43.502444 ,	80.255,		0,		0,		0],
"Pr3+edvardson",	["4f2",	"",	"",	"Pr3+",	4./5,	0.643595, 4.4743894, 33.632765,	93.1989,	8539.78,	6242.23,	4079.2],
"Nd3+edvardson",	["4f3",	"",	"",	"Nd3+",	8./11,	0.589004, 3.824625, 26.92972 ,	109.763,	9053.08,	6545,		4433.3],
"Sm3+edvardson",	["4f5",	"",	"",	"Sm3+",	2./7,	0.510341, 2.9411772, 18.560283,	145.805,	9894.56,	7088.8,		4990.36],
"Eu3+edvardson",	["4f6",	"",	"",	"Eu3+",	0.,	0.47856, 2.6292946, 15.829346,	165.891,	10306.2,	7348.29,	5276.77],
"Gd3+edvardson",	["4f7",	"",	"",	"Gd3+",	2.,	0.451218, 2.3883811, 13.784848,	186.968,	10621.6,	7541.34,	5551.52],
"Tb3+edvardson",	["4f8",	"",	"",	"Tb3+",	3./2,	0.425961, 2.1861441, 12.12365,	211.641,	11034,		7800.96,	5858.5],
"Dy3+edvardson",	["4f9",	"",	"",	"Dy3+",	4./3,	0.401577, 2.0163423, 10.769904,	237.182,	11394.5,	7981.11,	6123.08],
"Ho3+edvardson",	["4f10","",	"",	"Ho3+",	5./4,	0.37746, 1.8715696, 9.6374985,	265.946,	11724.4,	8232.18,	6449.91],
"Er3+edvardson",	["4f11","",	"",	"Er3+",	6./5,	0.352488, 1.7486079, 8.692361,	294.586,	12086.4,	8419.02,	6696.39],
"Tm3+edvardson",	["4f12","",	"",	"Tm3+",	7./6,	0.33004, 1.6431685, 7.8933654 ,	326.822,	12415,		8630.91,	6940.01],
"Yb3+edvardson",	["4f13","",	"",	"Yb3+",	8./7,	0.30459, 1.55298, 7.21309 ,	363.026,	0,		0,		0],
);



# radial integrals by edvardsson  Journal Alloy Comp 275-277 (1998) 230
# calculated from the table 1 by
# R2=(1-col3)*col8
# R4=(1-col5)*col9
# R6=(1-col7)*col10

#element		sigma2		sigma4		sigma6		 <r^2> <r^4> <r^6>     gammainf in a.u. R2  R4  R6 
#"Ce3+edvardson" 0 0.510 0 0.0132 0 -0.0294 1.456 5.437 42.26 -65.5 -66.0                0.71344, 5.3652316, 43.502444 
#"Pr3+edvardson" 0.514 0.515 0.0150 0.0138 -0.0302 -0.0301 1.327 4.537 32.65 -64.2 -65.0 0.643595, 4.4743894, 33.632765 
#"Nd3+edvardson" 0.515 0.518 0.0164 0.0130 -0.0307 -0.0310 1.222 3.875 26.12 -62.8 -64.0 0.589004, 3.824625, 26.92972 
#"Pm3+edvardson" 0.512 0.519 0.0175 0.0109 -0.0309 -0.0314 1.135 3.366 21.46 -61.8 -63.3 0.545935, 3.3293106, 22.133844 
#"Sm3+edvardson" 0.507 0.519 0.0184 0.0077 -0.0309 -0.0317 1.061 2.964 17.99 -60.8 -62.6 0.510341, 2.9411772, 18.560283 
#"Eu3+edvardson" 0.502 0.520 0.0190 0.0033 -0.0308 -0.0319 0.997 2.638 15.34 -59.8 -61.9 0.47856, 2.6292946, 15.829346 
#"Gd3+edvardson" 0.494 0.521 0.0192 -0.0031 -0.0304 -0.0318 0.942 2.381 13.36 -58.8 -61.3 0.451218, 2.3883811, 13.784848 
#"ТЬ3+edvardson" 0.486 0.523 0.0193 -0.0107 -0.0300 -0.0318 0.893 2.163 11.75 -58.1 -60.8 0.425961, 2.1861441, 12.12365 
#"Dy3+edvardson" 0.477 0.527 0.0193 -0.0199 -0.0295 -0.0316 0.849 1.977 10.44 -57.2 -60.3 0.401577, 2.0163423, 10.769904 
#"Ho3+edvardson" 0.469 0.534 0.0192 -0.0306 -0.0289 -0.0313 0.810 1.816 9.345 -56.4 -59.9 0.37746, 1.8715696, 9.6374985 
#"Er3+edvardson" 0.460 0.544 0.0190 -0.0427 -0.0283 -0.0310 0.773 1.677 8.431 -55.6 -59.4 0.352488, 1.7486079, 8.692361 
#"Tm3+edvardson" 0.450 0.554 0.0188 -0.0567 -0.0277 -0.0306 0.740 1.555 7.659 -54.9 -59.0 0.33004, 1.6431685, 7.8933654 
#"Yb3+edvardson" 0.441 0.571 0.0185 -0.0725 -0.0270 -0.0300 0.710 1.448 7.003 -54.2 -58.7 0.30459, 1.55298, 7.21309 
#"Lu3+edvardson" 0.431 0.588 0.0182 -0.0902 -0.0263 -0.0294 0.682 1.353 6.441 -53.6 -58.4 0.280984, 1.4750406, 6.6303654 
