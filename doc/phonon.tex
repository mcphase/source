...
MODPAR9=3 #  to easy convegergence of mcphasit the linearity of the einstein Oscillator is damped 
            #  i.e. instead of  u0=-StOS*F we use  u0=-StOS * F * exp(-MODPAR9*|F|)
...
parameters. For an example see {\prg examples/cecu2ge2\_cf\_phonon\_int }.
