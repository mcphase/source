...
\markboth{\hfill \includegraphics[angle=20,height=20pt,bb=0 0  49 35]{../mcphas_logo1.jpg} }
...
technical devices. \oo hates formulas.
...
look up what. The third person the reader will meet is \pp, though
 he is simple minded he is a 
strong personality and will not tolerate any other opinion. He tries to
...
Jesus Blanco, Maurits Haverkort, Adnrea Severing,
...
\item    Electric Field and orientational Polarisation
...
\item   {\prg singleion} options  introduced for dynamical static susceptibility and INS scattering function
...
excitations under magnetic and electic fields and stress/pressure.
...
Note that by ''external magnetic field $\mbf H$'' we refer to the magnetic field in the sample, which is the applied field (e.g. generated by a coil) diminished by 
the demagnetizing factor $n_{\rm demag}$ times the magnetisation $\mbf M$ of the sample, i.e. 
$\mbf H= \mbf H_{\rm applied} - n_{\rm demag} \mbf M$, e.g. for a spherical sample $n_{\rm demag}=1/3$. 
