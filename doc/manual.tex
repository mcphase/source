...
\item           tb2ti2o7 example for cf-phonon interaction
...
\item {\prg mcdisp}\index{mcdisp} option -ignore\_non\_hermitian\_matrix\_error introduced , eigensolvers updated, option -jqe introduced to output all eigenvalues of J(q) to file mcdisp.jq
\item {\prg simannfit}\index{simannfit} options -n, -p  introduced, for storage of parametersets and probing parspace during fitting.
