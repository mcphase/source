...
{\bf   USERS MANUAL}\\
  \vspace{2cm} 
 Checkout our workshops at the McPhase homepage  
...
\vspace{1cm}
\includegraphics[bb=100 100 700 180,angle=0, width=0.9\textwidth]{figsrc/McPhaseVenice.jpg}
\vspace{1cm}}
...
and actinide ions. By means of magnetoelastic interactions 
