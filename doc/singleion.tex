...
\EE Look, \ee, in Fig.~\ref{chrgpla} and
...
\EE It is the possibility to couple various such calculations by interactions and
describe ordering phenomena and dispersive excitations.

\OO Indeed, the experiments I do are on ferrimagnets, so the theory has to take 
...
\PP Ok, I understood what you mean by single ion moulde, but how can we do some calculation
